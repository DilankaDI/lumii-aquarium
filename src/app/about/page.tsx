...
//import { FaWandMagicSparkles, FaRulerCombined, FaFish, FaComments } from 'react-icons/fa6';
...
const AboutPage: React.FC = () => {
  ...
  return (
    ...
    <div className="bg-dark text-gray-200 min-h-screen font-sans transition-opacity duration-1000 opacity-100">
      {/* <Head>
        <title>About Us - AquaPro</title>
      </Head> */}

      {/* This assumes you have a separate Navbar component */}
      {/* <Navbar /> */}
      ...
      <main>
        ...
        {/* <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6 lg:px-8 text-center">
            ...
            >
              {[
                { icon: <FaWandMagicSparkles size={40} />, title: "Maintenance", description: "AquaPro offers aquarium cleaning or regularly scheduled professional maintenance." },
                { icon: <FaRulerCombined size={40} />, title: "Design & Install", description: "AquaPro has installed many types of aquariums in both commercial and residential locations." },
                { icon: <FaFish size={40} />, title: "Health Services", description: "AquaPro can provide you with a fast accurate diagnosis. We will discuss with you the best course of action." },
                { icon: <FaComments size={40} />, title: "Consultation", description: "Whether you are a beginner or if you have an expert level question, AquaPro can help!" },
              ].map((service, index) => (
                <motion.div key={index} variants={itemVariants} className="flex flex-col items-center">
                  <div className="bg-teal-400 text-white rounded-full w-24 h-24 flex items-center justify-center mb-6 transition-transform duration-300 hover:scale-110">
                    {service.icon}
                  </div>
                  <h3 className="text-2xl font-bold mb-2">{service.title}</h3>
                  <p className="text-gray-600 mb-4">{service.description}</p>
                  <a href="#" className="text-teal-500 font-semibold hover:underline">MORE INFO</a>
                </motion.div>
              ))}
            </motion.div>
          </div>
        ...
        {/* Aquarium Maintenance Services Section */}
        {/* <motion.section
          className="py-20 bg-teal-500 text-white"
          // 2. CORRECT the prop name from 'Variants' to 'variants'
          variants={sectionVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          style={{ backgroundImage: "url('/path-to-your-teal-pattern.png')" }} // Optional: add a subtle background pattern
        >
          <div className="container mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              <img src="https://images.unsplash.com/photo-1522069169874-c58ec4b76259?q=80&w=2070&auto=format&fit=crop" alt="Colorful fish in an aquarium" className="rounded-lg shadow-2xl" />
            </motion.div>
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.4 }}
            >
              <h3 className="text-3xl lg:text-4xl font-bold mb-4">Aquarium Maintenance Services</h3>
              <p className="mb-6">
              ...
              <a href="#" className="bg-white text-teal-500 font-bold py-3 px-6 rounded-md transition-transform duration-300 hover:bg-gray-100">
                MORE INFO
              </a>
            </motion.div>
          </div>
